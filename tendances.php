...
$trucpafetcher = $db->query(" SELECT  messages.*,  utilisateurs.pseudo FROM messages JOIN utilisateurs  ON messages.utilisateur_id = utilisateurs.id ORDER BY messages.likes DESC
");
                        ...
                        <article class="bg-white border border-[#E5E5E5] rounded-xl p-6 hover:shadow">
                            ...
                            <div class="flex gap-24 items-center justify-center pb-2 pt-4">
                                ...
                                <div class="cursor-pointer">
                                    <button type="submit favorite-button" data-post-id="<?= $lesmessages['id'] ?>">
                                        <img src="./logos/bookmark.png" alt="Favourite" class="w-6 h-6 favorite-icon">
                                    </button>
